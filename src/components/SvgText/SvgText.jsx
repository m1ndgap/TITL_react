...
//   animation: ${fillDash} 2s ease-in 1400ms forwards , ${fillOffset} 2s ease-in 1400ms forwards;
// `
//
// const AnimatedPathFill = styled(AnimatedPath)`
//   transition: all 300ms ease-in-out;
//   animation: ${fillDash} 2s ease-in 1400ms forwards , ${fillOffset} 2s ease-in 1400ms forwards, ${fillBG} 1.5s ease-in 2000ms forwards
// `;
//
// const SvgPathWrap = styled.svg`
//   cursor: pointer;
//
//   &:hover {
//     path {
...
//   background-image: linear-gradient(to top, #000000 0% 50%, transparent 50% 100%);
//   background-position: 0 0;
//   text-shadow: none;
//   transition: background-position 300ms, text-shadow 300ms;
//   animation: ${fillClipText} 2000ms ease-in 1400ms forwards, ${textShadow} 2000ms ease-in 2000ms forwards;
//   pointer-events: none;
// `

// const ClippedG = styled(Clipped)`
//   top: 100px;
//   left: 2px;
// `
//
// const ClippedO = styled(Clipped)`
//   top: 100px;
//   left: 73px;
// `
//
// const ClippedA = styled(Clipped)`
//   top: 100px;
//   left: 146px;
// `
// const ClippedL = styled(Clipped)`
//   top: 100px;
//   left: 215px;
// `
// const ClippedS = styled(Clipped)`
//   top: 100px;
//   left: 246px;
// `
//
...
//   clip-path: url(#g-clip);
// `

// const Arrow = styled.div`
//   position: absolute;
//   opacity: 0;
//   animation: ${opacityIn} 1000ms ease-in 2000ms forwards;
// `
//
...
const SvgText = () => {
    ...
    useEffect(() => {
        svg.current.querySelectorAll(`path`).forEach((path) => {
            ...
            //path.setAttribute("stroke-dasharray", pathLength - 20);
        })
        svg.current.querySelectorAll(`g`).forEach((grp) => {
            grp.addEventListener('hover', () => {
                console.log(grp.querySelectorAll(`path`))
            })
        })
    }, [])
    ...
    return (
        <div className={"svg-text-wrap"} ref={svg}>
            {/*<ClippedDiv>*/}

            {/*</ClippedDiv>*/}
            {/*<div className={"clipped clipped-g"}>g</div>*/}
            {/*<div className={"clipped clipped-o"}>o</div>*/}
            {/*<div className={"clipped clipped-a"}>a</div>*/}
            {/*<div className={"clipped clipped-l"}>l</div>*/}
            {/*<div className={"clipped clipped-s"}>s</div>*/}
            <svg className="clip-goals-mask" width="1187px" height="520px"  viewBox="0 0 1187 510">
                <clipPath id="goals-clip" >
                    <path d="M49.725,158.634c0.303-0.302,0.67-0.455,1.105-0.455h15.21
                    ...
                    <path d="M91.52,220.319c-5.2-3.813-8.754-9.013-10.66-15.6
                    ...
                    <path d="M194.869,160.064c4.42,1.95,7.865,4.615,10.335,7.995
                    ...
                    <path d="M222.233,224.544c-0.305-0.303-0.455-0.67-0.455-1.105v-87.88
                    ...
                    <path  d="M264.937,223.439c-4.335-1.645-7.692-3.942-10.075-6.89
            ...
            <svg className="clip-briefs-mask" width="1187px" height="520px"  viewBox="0 0 1187 510">
                <clipPath id="briefs-clip">
                    <path d="M776.881,321.33c0,5.979-0.736,11.225-2.209,15.729
                    ...
                    <path d="M829.531,289.09c0.691,0.348,0.951,0.997,0.779,1.95l-2.73,14.82
                    ...
                    <path d="M841.164,277.715c-1.949-1.949-2.924-4.397-2.924-7.345
                    ...
                    <path d="M931.447,325.75c-0.086,1.04-0.648,1.56-1.689,1.56h-40.17
                    ...
                    <path d="M980.393,288.505c0.303,0.305,0.455,0.673,0.455,1.105v12.35
                    ...
                    <path d="M1001.26,353.44c-4.336-1.646-7.693-3.943-10.076-6.891
            ...
            <div className="clip-goals">

            </div>
            <div className="clip-briefs">

            </div>
            <div className={"arrow-svg arrow-svg--1"}>
                <svg width="30" height="23" viewBox="0 0 20 13" >
            ...
            <div className={"arrow-svg arrow-svg--2"}>
                <svg width="30" height="23" viewBox="0 0 20 13" >
                    <path d="M13.4176 0L20 6.5L13.4176 13L11.8065 11.4091L15.6387 7.62492H2.88082e-07L0 5.37508H15.6387L11.8065 1.59088L13.4176 0Z" fill="#D94343"/>
                </svg>
            </div>
            <svg className={"svg-path-wrap"} width="1187px" height="520px" viewBox="0 0 1187 510">
                <g className={"grp-svg svgYou svgGrp"}>
                    <path className={"animated-path"} d="M33.085,94.415c-0.305-0.303-0.455-0.67-0.455-1.105v-32.89
                    ...
                    <path className={"animated-path"} d="M89.179,90.319c-5.2-3.813-8.754-9.013-10.66-15.6
                    c-1.215-4.073-1.82-8.493-1.82-13.26c0-5.113,0.605-9.705,1.82-13.78c1.993-6.413,5.59-11.44,10.79-15.08
                    c5.2-3.64,11.44-5.46,18.72-5.46c7.105,0,13.173,1.799,18.2,5.395c5.025,3.597,8.58,8.602,10.66,15.015
                    c1.386,4.335,2.08,8.885,2.08,13.65c0,4.68-0.607,9.057-1.82,13.13c-1.907,6.76-5.44,12.07-10.595,15.925
                    ...
                    <path className={"animated-path"} d="M190.252,28.634c0.303-0.302,0.67-0.455,1.105-0.455h15.21
                ...
                <g className={"grp-svg svgGive svgGrp"}>
                    <path className={"animated-path"} d="M288.922,28.634c0.303-0.302,0.67-0.455,1.105-0.455h15.21
                    c0.433,0,0.8,0.152,1.105,0.455c0.303,0.305,0.455,0.672,0.455,1.105v59.28c0,11.353-3.272,19.455-9.815,24.31
                    c-6.545,4.853-14.973,7.28-25.285,7.28c-3.035,0-6.415-0.217-10.14-0.65c-0.867-0.087-1.3-0.65-1.3-1.69l0.52-13.39
                    c0-1.127,0.605-1.604,1.82-1.43c3.12,0.52,5.98,0.78,8.58,0.78c5.545,0,9.815-1.215,12.805-3.64c2.99-2.427,4.485-6.325,4.485-11.7
                    c0-0.26-0.087-0.411-0.26-0.455c-0.174-0.042-0.347,0.022-0.52,0.195c-3.294,3.555-8.104,5.33-14.43,5.33
                    ...
                    <path className={"animated-path"} d="M322.461,17.714c-1.95-1.95-2.925-4.397-2.925-7.345
                    ...
                    <path className={"animated-path"} d="M369.975,93.7l-20.8-63.83c-0.087-0.173-0.13-0.39-0.13-0.65
                    ...
                    <path className={"animated-path"} d="M476.055,65.75c-0.087,1.04-0.65,1.56-1.69,1.56h-40.17
                ...
                <g className={"grp-svg svgUs svgGrp"}>
                    <path className={"animated-path"} d="M552.818,28.634c0.303-0.302,0.67-0.455,1.105-0.455h15.21
                    c0.433,0,0.8,0.152,1.105,0.455c0.303,0.305,0.455,0.672,0.455,1.105v63.7c0,0.435-0.152,0.802-0.455,1.105
                    ...
                    <path className={"animated-path"} d="M595.652,93.439c-4.334-1.645-7.692-3.942-10.075-6.89
                    c-2.385-2.945-3.575-6.282-3.575-10.01v-1.3c0-0.433,0.15-0.801,0.455-1.105c0.303-0.302,0.67-0.455,1.105-0.455h14.43
                ...
                <g className={"grp-svg svgYour svgGrp"}>
                    <path className={"animated-path"} d="M674.434,120.415c-0.176-0.305-0.26-0.672-0.26-1.105v-11.96
                    ...
                    <path className={"animated-path"} d="M747.494,90.319c-5.201-3.813-8.756-9.013-10.66-15.6
                    ...
                    <path className={"animated-path"} d="M848.568,28.634c0.303-0.302,0.67-0.455,1.105-0.455h15.209
                    ...
                    <path className={"animated-path"} d="M920.652,29.089c0.693,0.348,0.953,0.998,0.781,1.95l-2.73,14.82
                ...
                <g className={"grp-svg svgGoals svgGrp"}
                    onMouseEnter={() => dispatch({type: "toggle_goals"})}
                    onMouseLeave={() => dispatch({type: "toggle_clear"})}
                >
                    <path className={'animated-path'} d="M49.725,158.634c0.303-0.302,0.67-0.455,1.105-0.455h15.21
                    c0.433,0,0.8,0.152,1.105,0.455c0.303,0.305,0.455,0.672,0.455,1.105v59.28c0,11.353-3.272,19.455-9.815,24.31
                    c-6.545,4.853-14.973,7.28-25.285,7.28c-3.035,0-6.415-0.217-10.14-0.65c-0.867-0.087-1.3-0.65-1.3-1.69l0.52-13.39
                    c0-1.127,0.605-1.604,1.82-1.43c3.12,0.52,5.98,0.78,8.58,0.78c5.545,0,9.815-1.215,12.805-3.64c2.99-2.427,4.485-6.325,4.485-11.7
                    c0-0.26-0.087-0.411-0.26-0.455c-0.174-0.042-0.347,0.022-0.52,0.195c-3.294,3.555-8.104,5.33-14.43,5.33
                    ...
                    c0.78,2.34,2.145,4.225,4.095,5.655c1.95,1.43,4.268,2.145,6.955,2.145c2.773,0,5.07-0.715,6.89-2.145
                    c1.82-1.43,3.075-3.27,3.77-5.525C48.922,199.129,49.27,195.577,49.27,191.069z"/>
                    <path className={"animated-path"} d="M91.52,220.319c-5.2-3.813-8.754-9.013-10.66-15.6
                    c-1.215-4.073-1.82-8.493-1.82-13.26c0-5.113,0.605-9.705,1.82-13.78c1.993-6.413,5.59-11.44,10.79-15.08
                    c5.2-3.64,11.44-5.46,18.72-5.46c7.105,0,13.173,1.799,18.2,5.395c5.025,3.597,8.58,8.602,10.66,15.015
                    c1.386,4.335,2.08,8.885,2.08,13.65c0,4.68-0.607,9.057-1.82,13.13c-1.907,6.76-5.44,12.07-10.595,15.925
                    c-5.157,3.857-11.375,5.785-18.655,5.785S96.72,224.134,91.52,220.319z M117.52,207.709c1.993-1.732,3.423-4.115,4.29-7.15
                    ...
                    c-0.694,2.08-1.04,5.157-1.04,9.23c0,3.9,0.303,6.935,0.91,9.1c0.865,3.035,2.318,5.417,4.355,7.15
                    c2.035,1.735,4.528,2.6,7.475,2.6C113.1,210.31,115.525,209.444,117.52,207.709z"/>
                    <path className={"animated-path"} d="M194.869,160.064c4.42,1.95,7.865,4.615,10.335,7.995
                    c2.47,3.38,3.705,7.15,3.705,11.31v44.07c0,0.435-0.152,0.802-0.455,1.105c-0.305,0.305-0.672,0.455-1.105,0.455h-15.21
                    c-0.435,0-0.802-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.105v-4.29c0-0.26-0.087-0.433-0.26-0.52
                    c-0.175-0.085-0.347,0-0.52,0.26c-3.64,4.767-9.49,7.15-17.55,7.15c-6.76,0-12.22-1.646-16.38-4.94
                    c-4.16-3.293-6.24-8.146-6.24-14.56c0-6.673,2.34-11.851,7.02-15.535c4.68-3.683,11.353-5.525,20.02-5.525h13.26
                    ...
                    c-2.21,1.475-3.315,3.555-3.315,6.24c0,2.34,0.823,4.182,2.47,5.525c1.645,1.345,3.855,2.015,6.63,2.015
                    C180.914,212.39,184.079,211.394,186.678,209.399z"/>
                    <path className={"animated-path"} d="M222.233,224.544c-0.305-0.303-0.455-0.67-0.455-1.105v-87.88
                    c0-0.433,0.15-0.8,0.455-1.105c0.303-0.303,0.67-0.455,1.105-0.455h15.21c0.433,0,0.8,0.152,1.105,0.455
                    c0.303,0.305,0.455,0.672,0.455,1.105v87.88c0,0.435-0.152,0.802-0.455,1.105c-0.305,0.305-0.672,0.455-1.105,0.455h-15.21
                    C222.904,225,222.536,224.849,222.233,224.544z"/>
                    <path className={"animated-path"} d="M264.937,223.439c-4.335-1.645-7.692-3.942-10.075-6.89
                    c-2.385-2.945-3.575-6.282-3.575-10.01v-1.3c0-0.433,0.15-0.801,0.455-1.105c0.303-0.302,0.67-0.455,1.105-0.455h14.43
                    c0.433,0,0.8,0.152,1.105,0.455c0.303,0.305,0.455,0.672,0.455,1.105v0.13c0,1.907,1.06,3.532,3.185,4.875
                    c2.123,1.345,4.788,2.015,7.995,2.015c2.945,0,5.33-0.585,7.15-1.755c1.82-1.17,2.73-2.62,2.73-4.355c0-1.56-0.78-2.73-2.34-3.51
                    c-1.56-0.78-4.117-1.603-7.67-2.47c-4.075-1.04-7.28-2.035-9.62-2.99c-5.547-1.905-9.967-4.246-13.26-7.02
                ...
                <path className={"animated-path"} d="M317.327,236.049l4.29-30.16c0.085-0.953,0.65-1.43,1.69-1.43h13.26
                ...
                <g className={"grp-svg svgReqs svgGrp"}>
                    <path className={"animated-path"} d="M419.896,159.089c0.692,0.348,0.953,0.998,0.78,1.95l-2.73,14.82
                    ...
                    <path className={"animated-path"} d="M486.978,195.75c-0.087,1.04-0.65,1.56-1.69,1.56h-40.17
                    c-0.52,0-0.694,0.217-0.52,0.65c0.26,1.735,0.735,3.467,1.43,5.2c2.252,4.854,6.845,7.28,13.78,7.28
                    c5.545-0.085,9.923-2.34,13.13-6.76c0.345-0.52,0.735-0.78,1.17-0.78c0.26,0,0.563,0.175,0.91,0.52l9.36,9.23
                    c0.433,0.435,0.65,0.825,0.65,1.17c0,0.175-0.175,0.52-0.52,1.04c-2.86,3.555-6.544,6.305-11.05,8.255
                    c-4.507,1.95-9.447,2.925-14.82,2.925c-7.455,0-13.76-1.69-18.915-5.07c-5.157-3.38-8.862-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M540.211,158.634c0.303-0.302,0.67-0.455,1.105-0.455h15.21
                    ...
                    <path className={"animated-path"} d="M611.58,158.634c0.303-0.302,0.67-0.455,1.105-0.455h15.209
                    c0.434,0,0.801,0.152,1.105,0.455c0.303,0.305,0.455,0.672,0.455,1.105v63.7c0,0.435-0.152,0.802-0.455,1.105
                    c-0.305,0.305-0.672,0.455-1.105,0.455h-15.209c-0.436,0-0.803-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.105v-4.42
                    ...
                    <path className={"animated-path"} d="M645.51,147.714c-1.951-1.95-2.926-4.397-2.926-7.345
                    ...
                    <path className={"animated-path"} d="M716.813,159.089c0.693,0.348,0.953,0.998,0.781,1.95l-2.73,14.82
                    c-0.088,1.04-0.695,1.345-1.82,0.91c-1.301-0.433-2.818-0.65-4.551-0.65c-0.693,0-1.646,0.087-2.859,0.26
                    c-3.119,0.26-5.766,1.41-7.93,3.445c-2.168,2.037-3.25,4.745-3.25,8.125v35.49c0,0.435-0.152,0.802-0.455,1.105
                    c-0.305,0.305-0.672,0.455-1.105,0.455h-15.209c-0.436,0-0.803-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.105v-63.7
                    c0-0.433,0.15-0.801,0.455-1.105c0.303-0.302,0.67-0.455,1.105-0.455h15.209c0.434,0,0.801,0.152,1.105,0.455
                    ...
                    <path className={"animated-path"} d="M783.895,195.75c-0.088,1.04-0.65,1.56-1.689,1.56h-40.17
                    ...
                    <path className={"animated-path"} d="M885.162,163.25c3.813,4.075,5.721,9.795,5.721,17.16v43.03
                    ...
                    <path className={"animated-path"} d="M963.033,195.75c-0.088,1.04-0.65,1.56-1.689,1.56h-40.17
                    c-0.521,0-0.695,0.217-0.521,0.65c0.26,1.735,0.736,3.467,1.432,5.2c2.252,4.854,6.844,7.28,13.779,7.28
                    c5.545-0.085,9.922-2.34,13.129-6.76c0.346-0.52,0.736-0.78,1.17-0.78c0.262,0,0.564,0.175,0.91,0.52l9.361,9.23
                    c0.432,0.435,0.65,0.825,0.65,1.17c0,0.175-0.176,0.52-0.521,1.04c-2.859,3.555-6.545,6.305-11.049,8.255
                    c-4.508,1.95-9.447,2.925-14.82,2.925c-7.455,0-13.76-1.69-18.916-5.07c-5.156-3.38-8.861-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M1025.951,163.509c4.246,4.248,6.371,10.01,6.371,17.29v42.64
                    ...
                    <path className={"animated-path"} d="M1083.346,172.415c-0.305,0.305-0.672,0.455-1.105,0.455h-12.479
                    ...
                    <path className={"animated-path"} d="M1106.289,223.439c-4.334-1.645-7.691-3.942-10.074-6.89
                ...
                <path className={"animated-path"} d="M1158.68,236.049l4.289-30.16c0.086-0.953,0.65-1.43,1.689-1.43
                ...
                <g className={"grp-svg svgResearch svgGrp"}>
                    <path className={"animated-path"} d="M49.14,289.09c0.692,0.348,0.953,0.997,0.78,1.95l-2.73,14.82
                    ...
                    <path className={"animated-path"} d="M116.222,325.75c-0.087,1.04-0.65,1.56-1.69,1.56h-40.17
                    ...
                    <path className={"animated-path"} d="M138.062,353.44c-4.335-1.646-7.692-3.943-10.075-6.891
                    ...
                    <path className={"animated-path"} d="M251.551,325.75c-0.087,1.04-0.65,1.56-1.69,1.56h-40.17
                    c-0.52,0-0.694,0.218-0.52,0.65c0.26,1.734,0.735,3.468,1.43,5.2c2.252,4.854,6.845,7.28,13.78,7.28
                    c5.545-0.086,9.923-2.341,13.13-6.761c0.345-0.52,0.735-0.779,1.17-0.779c0.26,0,0.563,0.174,0.91,0.52l9.36,9.23
                    c0.433,0.435,0.65,0.824,0.65,1.17c0,0.175-0.175,0.52-0.52,1.04c-2.86,3.555-6.544,6.305-11.05,8.255
                    c-4.507,1.95-9.447,2.925-14.82,2.925c-7.455,0-13.76-1.69-18.915-5.07c-5.157-3.38-8.862-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M303.941,290.065c4.42,1.949,7.865,4.614,10.335,7.994
                    ...
                    <path className={"animated-path"} d="M371.542,289.09c0.692,0.348,0.953,0.997,0.78,1.95l-2.73,14.82
                    c-0.087,1.04-0.695,1.345-1.82,0.909c-1.3-0.433-2.817-0.649-4.55-0.649c-0.694,0-1.647,0.087-2.86,0.26
                    c-3.12,0.26-5.765,1.41-7.93,3.445c-2.167,2.037-3.25,4.745-3.25,8.125v35.49c0,0.435-0.152,0.802-0.455,1.104
                    ...
                    <path className={"animated-path"} d="M390.328,350.84c-5.07-3.465-8.689-8.232-10.855-14.3
                    ...
                    <path className={"animated-path"} d="M500.371,293.51c4.245,4.248,6.37,10.01,6.37,17.29v42.641
                    ...
                    <path className={"animated-path"} d="M579.151,325.75c-0.087,1.04-0.65,1.56-1.69,1.56h-40.17
                    c-0.52,0-0.694,0.218-0.52,0.65c0.26,1.734,0.735,3.468,1.43,5.2c2.252,4.854,6.845,7.28,13.78,7.28
                    c5.545-0.086,9.923-2.341,13.13-6.761c0.345-0.52,0.735-0.779,1.17-0.779c0.26,0,0.563,0.174,0.91,0.52l9.36,9.23
                    c0.433,0.435,0.65,0.824,0.65,1.17c0,0.175-0.175,0.52-0.52,1.04c-2.86,3.555-6.544,6.305-11.05,8.255
                    c-4.507,1.95-9.447,2.925-14.82,2.925c-7.455,0-13.76-1.69-18.915-5.07c-5.157-3.38-8.862-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M600.992,353.44c-4.336-1.646-7.693-3.943-10.076-6.891
                ...
                <path className={"animated-path"} d="M653.381,366.05l4.291-30.16c0.084-0.952,0.648-1.43,1.689-1.43
                ...
                <g className={"grp-svg svgBriefs svgGrp"}
                        onMouseEnter={() => dispatch({type: "toggle_briefs"})}
                        onMouseLeave={() => dispatch({type: "toggle_clear"})}>
                    <path className={"animated-path"} d="M776.881,321.33c0,5.979-0.736,11.225-2.209,15.729
                    c-1.994,5.896-5.18,10.53-9.555,13.91c-4.379,3.38-9.557,5.07-15.535,5.07c-6.328,0-11.311-2.383-14.951-7.15
                    c-0.174-0.172-0.348-0.237-0.52-0.194c-0.174,0.044-0.26,0.194-0.26,0.455v4.29c0,0.435-0.152,0.802-0.455,1.104
                    c-0.305,0.305-0.672,0.455-1.105,0.455h-15.209c-0.436,0-0.803-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.104v-87.88
                    c0-0.434,0.15-0.801,0.455-1.105c0.303-0.303,0.67-0.455,1.105-0.455h15.209c0.434,0,0.801,0.152,1.105,0.455
                    ...
                    c0,5.808,0.865,10.185,2.6,13.13c2.08,3.728,5.111,5.59,9.1,5.59c4.246,0,7.41-1.862,9.49-5.59
                    C756.992,331.428,757.902,327.095,757.902,321.72z"/>
                    <path className={"animated-path"} d="M829.531,289.09c0.691,0.348,0.951,0.997,0.779,1.95l-2.73,14.82
                    c-0.086,1.04-0.693,1.345-1.82,0.909c-1.299-0.433-2.816-0.649-4.549-0.649c-0.695,0-1.648,0.087-2.861,0.26
                    c-3.119,0.26-5.764,1.41-7.93,3.445c-2.166,2.037-3.25,4.745-3.25,8.125v35.49c0,0.435-0.152,0.802-0.455,1.104
                    c-0.305,0.305-0.672,0.455-1.104,0.455H790.4c-0.434,0-0.803-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.104v-63.7
                    c0-0.433,0.15-0.801,0.455-1.105c0.303-0.303,0.672-0.455,1.105-0.455h15.211c0.432,0,0.799,0.152,1.104,0.455
                    c0.303,0.305,0.455,0.673,0.455,1.105v4.939c0,0.261,0.086,0.435,0.26,0.521c0.174,0.087,0.303,0.045,0.391-0.13
                    c3.553-5.2,8.32-7.801,14.301-7.801C825.24,287.27,827.711,287.877,829.531,289.09z"/>
                    <path className={"animated-path"} d="M841.164,277.715c-1.949-1.949-2.924-4.397-2.924-7.345
                    c0-3.032,0.951-5.503,2.859-7.41c1.906-1.905,4.375-2.86,7.41-2.86c3.033,0,5.502,0.955,7.41,2.86
                    c1.904,1.907,2.859,4.378,2.859,7.41c0,2.947-0.975,5.396-2.924,7.345c-1.951,1.95-4.4,2.926-7.346,2.926
                    C845.563,280.641,843.115,279.665,841.164,277.715z M839.605,354.545c-0.305-0.303-0.455-0.67-0.455-1.104v-63.83
                    c0-0.433,0.15-0.801,0.455-1.105c0.303-0.303,0.67-0.455,1.104-0.455h15.211c0.432,0,0.801,0.152,1.105,0.455
                    c0.303,0.305,0.455,0.673,0.455,1.105v63.83c0,0.435-0.152,0.802-0.455,1.104c-0.305,0.305-0.674,0.455-1.105,0.455h-15.211
                    C840.275,355,839.908,354.85,839.605,354.545z"/>
                    <path className={"animated-path"} d="M931.447,325.75c-0.086,1.04-0.648,1.56-1.689,1.56h-40.17
                    c-0.52,0-0.695,0.218-0.52,0.65c0.26,1.734,0.734,3.468,1.43,5.2c2.252,4.854,6.846,7.28,13.779,7.28
                    c5.547-0.086,9.924-2.341,13.131-6.761c0.346-0.52,0.734-0.779,1.17-0.779c0.26,0,0.563,0.174,0.91,0.52l9.359,9.23
                    c0.434,0.435,0.65,0.824,0.65,1.17c0,0.175-0.174,0.52-0.52,1.04c-2.861,3.555-6.545,6.305-11.051,8.255
                    c-4.508,1.95-9.447,2.925-14.82,2.925c-7.453,0-13.76-1.69-18.914-5.07c-5.158-3.38-8.863-8.103-11.115-14.17
                    ...
                    c0,0.435,0.217,0.649,0.65,0.649h22.49c0.52,0,0.693-0.215,0.52-0.649c-0.434-2.513-0.65-3.726-0.65-3.641
                    c-0.779-2.6-2.145-4.614-4.094-6.045c-1.951-1.43-4.355-2.145-7.215-2.145C895.178,302.87,891.58,305.428,889.848,310.54z"/>
                    <path className={"animated-path"} d="M980.393,288.505c0.303,0.305,0.455,0.673,0.455,1.105v12.35
                    c0,0.435-0.152,0.803-0.455,1.105c-0.305,0.305-0.674,0.454-1.105,0.454h-12.609c-0.436,0-0.65,0.218-0.65,0.65v49.271
                    c0,0.435-0.152,0.802-0.455,1.104c-0.305,0.305-0.672,0.455-1.105,0.455h-15.209c-0.436,0-0.803-0.15-1.105-0.455
                    c-0.305-0.303-0.455-0.67-0.455-1.104V304.17c0-0.433-0.217-0.65-0.65-0.65h-7.67c-0.436,0-0.803-0.149-1.105-0.454
                    c-0.305-0.303-0.455-0.671-0.455-1.105v-12.35c0-0.433,0.15-0.801,0.455-1.105c0.303-0.303,0.67-0.455,1.105-0.455h7.67
                    ...
                    c0,0.436-0.152,0.803-0.455,1.105c-0.305,0.305-0.672,0.455-1.105,0.455h-4.289c-3.035,0.087-5.137,0.715-6.307,1.885
                    s-1.754,3.314-1.754,6.436v1.43c0,0.435,0.215,0.649,0.65,0.649h12.609C979.719,288.05,980.088,288.202,980.393,288.505z"/>
                    <path className={"animated-path"} d="M1001.26,353.44c-4.336-1.646-7.693-3.943-10.076-6.891
                    c-2.385-2.945-3.574-6.282-3.574-10.01v-1.3c0-0.433,0.15-0.801,0.455-1.105c0.303-0.303,0.67-0.455,1.105-0.455h14.43
                    c0.432,0,0.799,0.152,1.104,0.455c0.303,0.305,0.455,0.673,0.455,1.105v0.13c0,1.907,1.061,3.532,3.186,4.875
                    c2.123,1.345,4.787,2.015,7.996,2.015c2.945,0,5.33-0.585,7.148-1.755c1.82-1.17,2.73-2.62,2.73-4.354
                    c0-1.561-0.779-2.73-2.34-3.511c-1.561-0.779-4.117-1.603-7.67-2.47c-4.074-1.04-7.279-2.035-9.619-2.99
                ...
                <path className={"animated-path"} d="M1053.648,366.05l4.291-30.16c0.084-0.952,0.648-1.43,1.689-1.43
                h13.26c1.125,0,1.561,0.564,1.301,1.69l-8.061,30.29c-0.26,0.865-0.867,1.3-1.82,1.3h-9.23
                C1054.039,367.74,1053.561,367.176,1053.648,366.05z"/>
                <g className={"grp-svg svgExpectations svgGrp"}>
                    <path className={"animated-path"} d="M68.12,455.75c-0.087,1.04-0.65,1.56-1.69,1.56H26.26
                    c-0.52,0-0.694,0.218-0.52,0.65c0.26,1.734,0.735,3.468,1.43,5.2c2.252,4.854,6.845,7.28,13.78,7.28
                    c5.545-0.086,9.923-2.341,13.13-6.761c0.345-0.52,0.735-0.779,1.17-0.779c0.26,0,0.563,0.174,0.91,0.52l9.36,9.23
                    c0.433,0.435,0.65,0.824,0.65,1.17c0,0.175-0.175,0.52-0.52,1.04c-2.86,3.555-6.544,6.305-11.05,8.255
                    c-4.507,1.95-9.447,2.925-14.82,2.925c-7.455,0-13.76-1.69-18.915-5.07c-5.157-3.38-8.862-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M72.475,484.415c-0.217-0.39-0.152-0.845,0.195-1.365L93.6,451.98
                    ...
                    <path className={"animated-path"} d="M208.26,451.72c0,5.98-0.825,11.397-2.47,16.25
                    ...
                    <path className={"animated-path"} d="M279.37,455.75c-0.087,1.04-0.65,1.56-1.69,1.56h-40.17
                    c-0.52,0-0.694,0.218-0.52,0.65c0.26,1.734,0.735,3.468,1.43,5.2c2.252,4.854,6.845,7.28,13.78,7.28
                    c5.545-0.086,9.923-2.341,13.13-6.761c0.345-0.52,0.735-0.779,1.17-0.779c0.26,0,0.563,0.174,0.91,0.52l9.36,9.23
                    c0.433,0.435,0.65,0.824,0.65,1.17c0,0.175-0.175,0.52-0.52,1.04c-2.86,3.555-6.544,6.305-11.05,8.255
                    c-4.507,1.95-9.447,2.925-14.82,2.925c-7.455,0-13.76-1.69-18.915-5.07c-5.157-3.38-8.862-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M302.053,480.84c-5.07-3.465-8.689-8.232-10.855-14.3
                    c-1.475-4.333-2.21-9.445-2.21-15.34c0-5.806,0.735-10.833,2.21-15.08c2.08-5.893,5.675-10.53,10.79-13.91
                    c5.113-3.38,11.135-5.07,18.07-5.07c6.933,0,13.02,1.735,18.265,5.2c5.243,3.468,8.73,7.845,10.465,13.13
                    c0.692,2.08,1.04,3.641,1.04,4.681v0.26c0,0.78-0.435,1.257-1.3,1.43l-14.95,2.21h-0.26c-0.78,0-1.3-0.433-1.56-1.3l-0.39-2.08
                    c-0.607-2.253-1.95-4.115-4.03-5.59c-2.08-1.473-4.55-2.21-7.41-2.21c-2.774,0-5.114,0.694-7.02,2.08
                    ...
                    <path className={"animated-path"} d="M398.382,432.415c-0.305,0.305-0.672,0.455-1.105,0.455h-12.48
                    ...
                    <path className={"animated-path"} d="M451.616,420.065c4.42,1.949,7.865,4.614,10.335,7.994
                    c2.47,3.381,3.705,7.15,3.705,11.311v44.07c0,0.435-0.152,0.802-0.455,1.104c-0.305,0.305-0.672,0.455-1.105,0.455h-15.21
                    c-0.435,0-0.802-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.104v-4.29c0-0.261-0.087-0.433-0.26-0.521
                    c-0.175-0.085-0.347,0-0.52,0.26c-3.64,4.768-9.49,7.15-17.55,7.15c-6.76,0-12.22-1.646-16.38-4.94
                    c-4.16-3.292-6.24-8.145-6.24-14.56c0-6.673,2.34-11.851,7.02-15.535c4.68-3.683,11.353-5.524,20.02-5.524h13.26
                    ...
                    <path className={"animated-path"} d="M514.992,432.415c-0.305,0.305-0.672,0.455-1.105,0.455h-12.48
                    c-0.435,0-0.65,0.217-0.65,0.649v27.561c0,2.86,0.585,4.984,1.755,6.37c1.17,1.387,3.055,2.08,5.655,2.08h4.29
                    c0.433,0,0.8,0.152,1.105,0.455c0.303,0.305,0.455,0.672,0.455,1.104v12.351c0,0.954-0.52,1.517-1.56,1.689
                    c-3.64,0.173-6.24,0.26-7.8,0.26c-7.194,0-12.567-1.19-16.12-3.574c-3.555-2.383-5.375-6.868-5.46-13.455V433.52
                    c0-0.433-0.218-0.649-0.65-0.649h-7.41c-0.435,0-0.803-0.15-1.105-0.455c-0.305-0.303-0.455-0.67-0.455-1.105V419.74
                    ...
                    <path className={"animated-path"} d="M529.031,407.715c-1.95-1.95-2.925-4.397-2.925-7.345
                    c0-3.033,0.953-5.503,2.86-7.41c1.905-1.905,4.375-2.86,7.41-2.86c3.033,0,5.502,0.955,7.41,2.86c1.905,1.907,2.86,4.377,2.86,7.41
                    ...
                    <path className={"animated-path"} d="M570.434,480.32c-5.2-3.813-8.754-9.013-10.66-15.601
                    ...
                    <path className={"animated-path"} d="M683.662,423.51c4.246,4.248,6.371,10.01,6.371,17.29v42.641
                    ...
                    <path className={"animated-path"} d="M714.602,483.44c-4.334-1.646-7.691-3.943-10.074-6.891
                    ...
                    <path className={"animated-path"} d="M766.992,496.05l4.289-30.16c0.086-0.952,0.65-1.43,1.689-1.43
                    ...
                    <g className={"grp-svg svgFears svgGrp"}>
                    <path className={"animated-path"} d="M868.066,418.505c0.303,0.305,0.455,0.673,0.455,1.105v12.35
                    ...
                    <path className={"animated-path"} d="M934.822,455.75c-0.086,1.04-0.648,1.56-1.689,1.56h-40.17
                    c-0.52,0-0.695,0.218-0.52,0.65c0.26,1.734,0.734,3.468,1.43,5.2c2.252,4.854,6.846,7.28,13.779,7.28
                    c5.547-0.086,9.924-2.341,13.131-6.761c0.346-0.52,0.734-0.779,1.17-0.779c0.26,0,0.563,0.174,0.91,0.52l9.359,9.23
                    c0.434,0.435,0.65,0.824,0.65,1.17c0,0.175-0.174,0.52-0.52,1.04c-2.861,3.555-6.545,6.305-11.051,8.255
                    c-4.508,1.95-9.447,2.925-14.82,2.925c-7.453,0-13.76-1.69-18.914-5.07c-5.158-3.38-8.863-8.103-11.115-14.17
                    ...
                    <path className={"animated-path"} d="M987.213,420.065c4.42,1.949,7.865,4.614,10.336,7.994
                    ...
                    <path className={"animated-path"} d="M1054.813,419.09c0.693,0.348,0.953,0.997,0.781,1.95l-2.73,14.82
                    ...
                    <path className={"animated-path"} d="M1074.313,483.44c-4.336-1.646-7.693-3.943-10.076-6.891
                    c-2.385-2.945-3.574-6.282-3.574-10.01v-1.3c0-0.433,0.15-0.801,0.455-1.105c0.303-0.303,0.67-0.455,1.105-0.455h14.43
                    c0.432,0,0.799,0.152,1.104,0.455c0.303,0.305,0.455,0.673,0.455,1.105v0.13c0,1.907,1.061,3.532,3.186,4.875
                    c2.123,1.345,4.787,2.015,7.996,2.015c2.945,0,5.33-0.585,7.148-1.755c1.82-1.17,2.73-2.62,2.73-4.354
                    c0-1.561-0.779-2.73-2.34-3.511c-1.561-0.779-4.117-1.603-7.67-2.47c-4.074-1.04-7.279-2.035-9.619-2.99
            ...
            <svg className={"svg-path-wrap"}>
                <clipPath id="g-clip" clipPathUnits="objectBoundingBox">
                    <path strokeDasharray="250" stroke='2' d="M0.707,0.016 C0.712,0.013,0.718,0.011,0.726,0.011 H0.974 C0.982,0.011,0.988,0.013,0.993,0.016 C0.998,0.019,1,0.023,1,0.028 V0.662 C1,0.783,0.946,0.87,0.839,0.922 C0.732,0.974,0.594,1,0.426,1 C0.376,1,0.321,0.998,0.26,0.993 C0.245,0.992,0.238,0.986,0.238,0.975 L0.247,0.832 C0.247,0.82,0.257,0.815,0.277,0.816 C0.328,0.822,0.374,0.825,0.417,0.825 C0.508,0.825,0.578,0.812,0.627,0.786 C0.676,0.76,0.7,0.718,0.7,0.661 C0.7,0.658,0.699,0.656,0.696,0.656 C0.693,0.655,0.69,0.656,0.687,0.658 C0.633,0.696,0.555,0.715,0.451,0.715 C0.359,0.715,0.274,0.7,0.197,0.671 C0.119,0.642,0.065,0.595,0.032,0.53 C0.011,0.487,0,0.432,0,0.364 C0,0.292,0.013,0.233,0.038,0.188 C0.068,0.131,0.118,0.086,0.189,0.051 C0.26,0.017,0.343,0,0.436,0 C0.545,0,0.629,0.021,0.687,0.064 C0.69,0.066,0.693,0.067,0.696,0.066 C0.699,0.066,0.7,0.064,0.7,0.061 V0.028 C0.7,0.023,0.702,0.019,0.707,0.016 M0.7,0.363 C0.7,0.334,0.699,0.312,0.696,0.296 C0.693,0.28,0.688,0.266,0.681,0.252 C0.668,0.227,0.647,0.207,0.617,0.191 C0.587,0.176,0.55,0.168,0.506,0.168 C0.464,0.168,0.428,0.176,0.398,0.191 C0.368,0.207,0.346,0.227,0.332,0.252 C0.312,0.28,0.302,0.317,0.302,0.364 C0.302,0.416,0.311,0.453,0.328,0.476 C0.34,0.501,0.363,0.521,0.395,0.536 C0.427,0.551,0.465,0.559,0.509,0.559 C0.554,0.559,0.591,0.551,0.621,0.536 C0.651,0.521,0.672,0.501,0.683,0.477 C0.694,0.449,0.7,0.411,0.7,0.363">
                        <animate begin="0"
                                 dur="5s"
                                 repeatCount="1"
